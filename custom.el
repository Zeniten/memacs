(custom-set-variables
 ...
 '(package-selected-packages
   '(aidermacs anki-editor auto-dark auto-package-update cider-storm
	       clojure-ts-mode consult corfu eros esup evil-cleverparens
	       evil-collection evil-mc evil-nerd-commenter expand-region general
	       git-timemachine gptel html-to-hiccup magit marginalia
	       modus-themes nodejs-repl orderless org-appear org-roam
	       skewer-mode sqlformat tempel try vertico which-key winum))
